...
def get_args():
    ...
    parser.add_argument('--data_path', default='/MyObjData')
    ...
    parser.add_argument('--pin_mem', type=bool, default=True, help='DataLoader pin_memory')
...
def train(opt):
    ...
    data_transform = {
        'train': T.Compose([
            ...
            T.Resize([scales[opt.compound_coef]], max_size=512),
            T.ColorJitter(),
            normalize,
        ]),
    ...
    training_set = CocoDataset(root=opt.data_path, transforms=data_transform['train'], train_set='train.txt')
    training_generator = DataLoader(training_set, **training_params)

    val_set = CocoDataset(root=opt.data_path, transforms=data_transform['valid'], train_set='val.txt')
